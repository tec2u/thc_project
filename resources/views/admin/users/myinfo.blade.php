                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <select id="country" name="country" class="form-control">
                                        ...
                                        <option value="AF" @if ($user->country == 'AF') selected="selected" @endif>
                                            Afghanistan</option>
                                        <option value="AX" @if ($user->country == 'AX') selected="selected" @endif>
                                            Aland
                                            Islands</option>
                                        <option value="AL" @if ($user->country == 'AL') selected="selected" @endif>
                                            Albania
                                        </option>
                                        <option value="DZ" @if ($user->country == 'DZ') selected="selected" @endif>
                                            Algeria
                                        </option>
                                        <option value="AS" @if ($user->country == 'AS') selected="selected" @endif>
                                            American
                                            Samoa</option>
                                        <option value="AD" @if ($user->country == 'AD') selected="selected" @endif>
                                            Andorra
                                        </option>
                                        <option value="AO" @if ($user->country == 'AO') selected="selected" @endif>
                                            Angola
                                        </option>
                                        <option value="AI" @if ($user->country == 'AI') selected="selected" @endif>
                                            Anguilla
                                        </option>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="number" class="form-control" id="cell" name="cell"
                                        placeholder="E.U.S" value="{{ $user->cell }}" />
                                </div>
                                <div class="form-group col-md-6">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="date" id="birthday" name="birthday" class="form-control"
                                        placeholder="Your Number" value="{{ $user->birthday }}" />
                                </div>
                            </div>
                            <div class="form-group col-md-6">
                                <label for="rule">@lang('admin.myinfo.rule')</label>
                                <select id="rule" name="rule" class="form-control">
                                    <option value="RULE_ADMIN" @if ($user->rule == 'RULE_ADMIN') selected @endif>
                                        @lang('admin.myinfo.admin')</option>
                                    <option value="RULE_USER" @if ($user->rule == 'RULE_USER') selected @endif>
                                        @lang('admin.myinfo.user')</option>
                                    <option value="RULE_SUPPORT" @if ($user->rule == 'RULE_SUPPORT') selected @endif>
                                        @lang('admin.myinfo.support')</option>
                                </select>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <label for="inputPassword1"
                                        class="col-sm-10 col-form-label">@lang('admin.myinfo.password')</label>
                                    <div class="col-sm-12">
                                ...
                                <div class="form-group col-md-6">
                                    <label for="inputPassword2"
                                        class="col-sm-10 col-form-label">@lang('admin.myinfo.confirmation')</label>
                                    <div class="col-sm-12">
