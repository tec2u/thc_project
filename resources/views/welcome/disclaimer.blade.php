...
<body style="overflow-x: hidden !important">
    ...
    <section class="espacoy2">
        <div class="container">
            ...
            All the information on this website www.nig-dubai.com is published in good faith and for general information purpose only. NextGen Investment Group does not make any warranties about the completeness, reliability and accuracy of this information. Any action you take upon the information you find on this website (Nextggen Investment Group), is strictly at your own risk. NextGen Investment Group will not be liable for any losses and/or damages in connection with the use of our website.
From our website, you can visit other websites by following hyperlinks to such external sites. While we strive to provide only quality links to useful and ethical websites, we have no control over the content and nature of these sites. These links to other websites do not imply a recommendation for all the content found on these sites. Site owners and content may change without notice and may occur before we have the opportunity to remove a link which may have gone ‘bad’.
Please be also aware that when you leave our website, other sites may have different privacy policies and terms which are beyond our control. Please be sure to check the Privacy Policy of the site as well as our Terms and Conditions before engaging in any business or uploading any information.
            </div>
        </div>
    </section>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-lg-2">
                        ...
                        <div class="d-flex flex-wrap">
                            <div class="my-div d-inline-block align-items-lg-center mb-3 mt-3"><a class="d-block footerlink" href="#">History</a></div>
                            <div class="my-div d-inline-block align-items-lg-center mb-3 mt-3"><a class="d-block footerlink" href="#">Front Page</a></div>
                        </div>
                        <div class="d-flex flex-wrap">
                            <div class="my-div d-inline-block align-items-lg-center mb-3"><a class="d-block footerlink" href="#">Approach</a></div>
                            <div class="my-div d-inline-block align-items-lg-center mb-3"><a class="d-block footerlink" href="#">Events</a></div>
                        </div>
                        <div class="d-flex flex-wrap">
                            <div class="my-div d-inline-block align-items-lg-center mb-3"><a class="d-block footerlink" href="#">Partners</a></div>
                            <div class="my-div d-inline-block align-items-lg-center mb-3"><a class="d-block footerlink" href="#">Team</a></div>
                        </div>
                        <div class="d-flex flex-wrap">
                            <!-- <div class="my-div d-inline-block align-items-lg-center mb-3"><a class="d-block footerlink" href="{{ route('.disclaimer') }}">Disclaimer</a></div> -->
                        </div>
