    ...
    <section>
        <div class="espacoy">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-4 text-center"><img class="img-fluid" src="../assetsWelcome/images/cartao1.png" width="320px">
                        <div class="my-4">
                            <h6 class="h6card">@lang('leadpage.card.cards.standardtitle')</h6>
                            <p class="text-black-50">@lang('leadpage.card.cards.standardsub')</p>
                        </div><a class="btn btn-warning d-block orderbtn orderbtnmarginsm" role="button" href="#">@lang('leadpage.card.cards.btn')</a>
                    </div>
                    <div class="col-md-4 text-center"><img class="img-fluid" src="../assetsWelcome/images/cartao3.png" width="320px">
                        <div class="my-4">
                            <h6 class="h6card">@lang('leadpage.card.cards.stainlesstitle')</h6>
                            <p class="text-black-50">@lang('leadpage.card.cards.stainlesssub')</p>
                        </div><a class="btn btn-warning d-block orderbtn orderbtnmarginsm" role="button" href="#"><span style="color: var(--bs-btn-hover-color); background-color: var(--bs-btn-hover-bg);">@lang('leadpage.card.cards.btn')</span></a>
                    </div>
                    <div class="col-md-4 text-center"><img class="img-fluid" src="../assetsWelcome/images/cartao2.png" width="320px">
                        <div class="my-4">
                            <h6 class="h6card">@lang('leadpage.card.cards.limitedtitle')</h6>
                            <p class="text-black-50">@lang('leadpage.card.cards.limitedsub')</p>
                        </div><a class="btn btn-warning d-block orderbtn" role="button" href="#"><span style="color: var(--bs-btn-hover-color); background-color: var(--bs-btn-hover-bg);">@lang('leadpage.card.cards.btn')</span></a>
                    </div>
                </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6 py-5" style="text-align: center;min-height: 400px;">
                        <div class="d-flex align-items-center divimg"><img class="img-fluid" data-aos="fade-right" data-aos-duration="1800" data-aos-once="true" src="assets/img/cardimggirl.png" width="600px" style="margin: auto;"></div>
                    </div>
                    <div class="col-md-6 columncardr py-5">
                        ...
                        <a class="btn btn-warning d-block orderbtn mt-5" role="button" href="#"><span style="color: var(--bs-btn-hover-color); background-color: var(--bs-btn-hover-bg);">@lang('leadpage.card.cards.btn')</span></a>
                    </div>
                </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6 order-md-last py-5" style="text-align: center;min-height: 400px;">
                        <div class="d-flex align-items-center divimg"><img class="img-fluid" data-aos="fade-left" data-aos-duration="1800" data-aos-once="true" src="assets/img/cardmaq.png" width="400px" style="margin: auto;"></div>
                    </div>
                    <div class="col-md-6 columncardr py-5">
        ...
        <div>
            <div class="accordion accordionbg" role="tablist" id="accordion-1">
                <div class="accordion-item accordionbg">
                    <h2 class="accordion-header" role="tab"><button class="accordion-button accordionbg" data-bs-toggle="collapse" data-bs-target="#accordion-1 .item-1" aria-expanded="true" aria-controls="accordion-1 .item-1" style="background: rgb(255,193,7);">@lang('leadpage.card.faq.question2')</button></h2>
                    <div class="accordion-collapse collapse show item-1" role="tabpanel" data-bs-parent="#accordion-1">
                        <div class="accordion-body">
                            <p class="mb-0">@lang('leadpage.card.faq.resp2')</p>
                        </div>
                    </div>
                </div>
                <div class="accordion-item accordionbg">
                    <h2 class="accordion-header" role="tab"><button class="accordion-button collapsed accordionbg" data-bs-toggle="collapse" data-bs-target="#accordion-1 .item-2" aria-expanded="false" aria-controls="accordion-1 .item-2" style="background: rgb(255,193,7);">@lang('leadpage.card.faq.question3')</button></h2>
                    <div class="accordion-collapse collapse item-2" role="tabpanel" data-bs-parent="#accordion-1">
                        <div class="accordion-body">
                            <p class="mb-0">@lang('leadpage.card.faq.resp3')</p>
                        </div>
                    </div>
                </div>
                <div class="accordion-item accordionbg">
                    <h2 class="accordion-header" role="tab"><button class="accordion-button collapsed accordionbg" data-bs-toggle="collapse" data-bs-target="#accordion-1 .item-3" aria-expanded="false" aria-controls="accordion-1 .item-3" style="background: rgb(255,193,7);">@lang('leadpage.card.faq.question4')</button></h2>
                    <div class="accordion-collapse collapse item-3" role="tabpanel" data-bs-parent="#accordion-1">
                        <div class="accordion-body">
                            <p class="mb-0">@lang('leadpage.card.faq.resp4')</p>
                        </div>
                    </div>
                </div>
                <div class="accordion-item accordionbg">
                    <h2 class="accordion-header" role="tab"><button class="accordion-button collapsed accordionbg" data-bs-toggle="collapse" data-bs-target="#accordion-1 .item-4" aria-expanded="false" aria-controls="accordion-1 .item-4" style="background: rgb(255,193,7);">@lang('leadpage.card.faq.question5')</button></h2>
                    <div class="accordion-collapse collapse item-4" role="tabpanel" data-bs-parent="#accordion-1">
                        <div class="accordion-body">
                            <p class="mb-0">@lang('leadpage.card.faq.resp5')</p>
                        </div>
                    </div>
                </div>
                {{-- <div class="accordion-item accordionbg">
                    <h2 class="accordion-header" role="tab"><button class="accordion-button collapsed accordionbg" data-bs-toggle="collapse" data-bs-target="#accordion-1 .item-5" aria-expanded="false" aria-controls="accordion-1 .item-5" style="background: rgb(255,193,7);">Accordion Item</button></h2>
