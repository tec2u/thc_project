    ...
    <div id="page-wrapper">
        ...
        <section id="hero-landing">
            <div class="container">
                <div class="row py-5">
                    <div class="col-12">
                        <div class="boxx m-auto text-center">
                            <h2>{{$indication->description}}</h2>
                            <iframe class="my-5" width="800" height="455" src="{{$indication->img_url}}" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                            @if (isset($login))
                            <a href="http://phpstack-884761-3067333.cloudwaysapps.com/{{$login}}"><button class="btn_header_logo_1">Join Now!</button></a>
                            @else
                            <a href="{{ route('register') }}"><button class="btn_header_logo_1">Join Now!</button></a>
                            @endif
